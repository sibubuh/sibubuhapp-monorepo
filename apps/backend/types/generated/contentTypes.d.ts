...
export interface ApiAnalyticAnalytic extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    google_analytic_tracking_id: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 255;
      }>;
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    attributes: Schema.Attribute.Component<'sections.footer', false> &
...
export interface ApiNavbarNavbar extends Struct.SingleTypeSchema {
  ...
  attributes: {
    attributes: Schema.Attribute.Component<'sections.navbar', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
  ...
  attributes: {
    ...
    sections: Schema.Attribute.DynamicZone<
      [
        ...
        'sections.footer',
        'sections.partners',
        'sections.company-intro',
        'sections.hero',
        'sections.vision-mission',
        'sections.image',
        'sections.sitemap',
        'sections.information-support',
        'sections.rich-text-section',
        'sections.quote',
        'sections.about-us',
        'sections.contact-us',
        'sections.raw-html',
        'sections.whistleblowing',
        'sections.text-headline',
        'sections.image-with-content',
        'sections.lottie',
        'sections.subheadline',
        'sections.multiple-download-item',
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    sections: Schema.Attribute.DynamicZone<['sections.reels-tiktok']>;
    seo: Schema.Attribute.Component<'shared.seo', false>;
    slug: Schema.Attribute.UID<'title'>;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiShareButtonShareButton extends Struct.SingleTypeSchema {
  collectionName: 'share_buttons';
  info: {
    description: '';
    displayName: 'Share Button';
    pluralName: 'share-buttons';
    singularName: 'share-button';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::share-button.share-button'
    >;
    publishedAt: Schema.Attribute.DateTime;
    sharer_group: Schema.Attribute.Component<'repeatable.sharer-url', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiWebIntroWebIntro extends Struct.SingleTypeSchema {
  collectionName: 'web_intros';
  info: {
    displayName: 'Web Intro';
    pluralName: 'web-intros';
    singularName: 'web-intro';
  };
  options: {
    draftAndPublish: true;
  };
