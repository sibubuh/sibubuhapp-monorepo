...
const slides = [
  { id: 1, title: "Sibubuh Agency", sub: "Architects of the modern web.", img: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&q=80&w=1920" },
